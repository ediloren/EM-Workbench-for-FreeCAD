...
#*                                                                         *
#*   Minor contributions:                                                  *
#*   Copyright (c) 2017  Simone Donadello  https://github.com/simondona/   *
#*                                                                         *
...
def export_mesh(filename, meshobj=None, isDiel=False, name="",
                showNormals=False, folder=DEF_FOLDER):
    '''export mesh in FasterCap format as conductor or dielectric interface

    The function operates on the selection if a mesh object is not passed.
    The selection can be a face, a compound or a solid.
    ...
    export_mesh("mymesh.qui", meshobj=mymeshObj, folder="C:/temp")

    Example 2:
    export_mesh("mymesh.qui", folder="C:/temp")
    '''
